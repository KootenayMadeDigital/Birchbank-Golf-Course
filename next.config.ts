...
const securityHeaders = [
  ...
  { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn2.chronogolf.com https://www.chronogolf.com https://plausible.io https://va.vercel-scripts.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://api.fontshare.com",
      "font-src 'self' data: https://fonts.gstatic.com https://cdn.fontshare.com https://api.fontshare.com",
      "img-src 'self' data: blob: https://cdn.sanity.io https://www.chronogolf.com https://www.birchbankgolf.com https://birchbankgolf.com",
      "connect-src 'self' https://plausible.io https://vitals.vercel-insights.com https://vercel.live https://www.chronogolf.com https://api.resend.com",
      "frame-src https://www.chronogolf.com https://members.chronogolf.com",
      "base-uri 'self'",
      "form-action 'self'",
