...
export const metadata: Metadata = {
  ...
  description:
    "Log in to the Birchbank members dashboard — advance tee-time booking, account management, and reciprocal-club access via Chronogolf.",
    ...
    <>
      <section className="pt-32 md:pt-40 pb-12 bg-paper">
        <div className="container-edge">
          <p className="eyebrow mb-6">Members dashboard</p>
          <h1
